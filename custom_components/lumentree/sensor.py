...
REALTIME_SENSOR_DESCRIPTIONS: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(key=KEY_BATTERY_TEMP, name="Battery Temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, state_class=SensorStateClass.MEASUREMENT, icon="mdi:thermometer-alert", suggested_display_precision=1),
    SensorEntityDescription(key=KEY_INVERTER_TEMP, name="Inverter Temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, state_class=SensorStateClass.MEASUREMENT, icon="mdi:thermometer-high", suggested_display_precision=1),
    SensorEntityDescription(key=KEY_BATTERY_CYCLES, name="Battery Cycles", state_class=SensorStateClass.TOTAL_INCREASING, icon="mdi:battery-sync", entity_category=EntityCategory.DIAGNOSTIC),
    SensorEntityDescription(key=KEY_SYSTEM_EFFICIENCY, name="System Efficiency", native_unit_of_measurement=PERCENTAGE, state_class=SensorStateClass.MEASUREMENT, icon="mdi:gauge", suggested_display_precision=1),
    SensorEntityDescription(key=KEY_POWER_FACTOR, name="Power Factor", state_class=SensorStateClass.MEASUREMENT, icon="mdi:sine-wave", suggested_display_precision=2),
    SensorEntityDescription(key=KEY_DC_BUS_VOLTAGE, name="DC Bus Voltage", native_unit_of_measurement=UnitOfElectricPotential.VOLT, device_class=SensorDeviceClass.VOLTAGE, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    SensorEntityDescription(key=KEY_FAULT_CODE, name="Fault Status", device_class=SensorDeviceClass.ENUM, icon="mdi:alert-circle-outline", entity_category=EntityCategory.DIAGNOSTIC),
    SensorEntityDescription(key=KEY_OPERATING_MODE, name="Operating Mode", device_class=SensorDeviceClass.ENUM, icon="mdi:cog-outline"),
    SensorEntityDescription(key=KEY_ENERGY_TODAY, name="Energy Generated Today", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.TOTAL_INCREASING, icon="mdi:lightning-bolt", suggested_display_precision=1),
    SensorEntityDescription(key=KEY_ENERGY_TOTAL, name="Total Energy Generated", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.TOTAL_INCREASING, icon="mdi:lightning-bolt-circle", suggested_display_precision=1),
    SensorEntityDescription(key=KEY_RUNTIME_HOURS, name="Runtime Hours", native_unit_of_measurement="h", icon="mdi:clock-outline", state_class=SensorStateClass.TOTAL_INCREASING, entity_category=EntityCategory.DIAGNOSTIC),
    SensorEntityDescription(key=KEY_MAX_POWER_TODAY, name="Max Power Today", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, icon="mdi:chart-line", entity_registry_enabled_default=False),
    SensorEntityDescription(key=KEY_MIN_VOLTAGE_TODAY, name="Min Voltage Today", native_unit_of_measurement=UnitOfElectricPotential.VOLT, device_class=SensorDeviceClass.VOLTAGE, icon="mdi:chart-line-stacked", entity_registry_enabled_default=False),
    SensorEntityDescription(key=KEY_MAX_TEMP_TODAY, name="Max Temperature Today", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, icon="mdi:thermometer-high", entity_registry_enabled_default=False),
)
